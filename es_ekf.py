...
#### 0. chooseing configuration#################################################################
submitOption = ['p1_submit', 'p2_submit','p3_submit']
submit_selector = submitOption[2]
...
if(submit_selector == submitOption[0]):
    var_imu_f = 0.10
    var_imu_w = 0.1
    var_gnss  = 0.01
    var_lidar = 1.00

if(submit_selector == submitOption[1]):
    var_imu_f = 0.10
    var_imu_w = 0.1
    var_gnss  = 0.01
    var_lidar =30.0

if(submit_selector == submitOption[2]):
    var_imu_f = 0.10
    var_imu_w = 0.1
    var_gnss  = 5.0
    var_lidar = 5.0
